...
> [!IMPORTANT]
> **Phạm vi hỗ trợ:** Hiện tại ứng dụng chỉ hỗ trợ tự động hóa đăng nhập, tải hóa đơn và giải mã captcha cho cổng CSKH của **Tổng công ty Điện lực miền Bắc (EVN NPC)**. Các khu vực khác (Miền Trung CPC, Miền Nam SPC, Hà Nội, TP.HCM) sử dụng hệ thống cổng CSKH và các mẫu captcha khác nên chưa được hỗ trợ trong phiên bản này.
